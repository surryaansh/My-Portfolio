...
export const PROJECTS_DATA = [
  ...
  {
    name: "MYDASH",
    description: "This is my modern, responsive, and optimized Next.js portfolio built with TypeScript and Tailwind CSS. It leverages reusable component abstractions and serverless API routes for dynamic content updates. Deployed on Vercel with a focus on maintainability and performance.",
  ...
  {
    name: "SURU GPT",
    description: "SuruGPT is a context-aware LLM system with RAG-based memory pipeline. Implementing persistent conversational memory using embeddings and semantic retrieval. It features automated summarization, vector storage, and relevance-based context injection.",
