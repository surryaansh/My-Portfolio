...
export const ProjectsRightPanel = forwardRef<HTMLDivElement, ProjectsRightPanelProps>(
  ({ isDarkMode, selectedProject, relativeCursorPosition, isHoveringLink, isScrolling, setIsHovering }, ref) => {
      ...
      <div className="w-full lg:col-span-2 flex flex-col lg:pl-6 pt-8 lg:pt-0">
        ...
        >
          ...
          <img
            ...
            className={`${imageBaseClasses} w-[22.5%] h-auto bottom-[18%] right-[25%]`}
            style={{ zIndex: 30 }}
            aria-hidden="true"
          />
