...
export const ProjectsRightPanel: React.FC<ProjectsRightPanelProps> = ({ isDarkMode, selectedProject }) => {
  ...
  return (
    <div className="w-full flex flex-col pt-4 lg:pt-0 lg:pl-6 flex-1 min-h-[50vh] lg:h-full">
      ...
      <div className="flex flex-col flex-1 lg:justify-between">
        ...
        */}
        <div className="flex justify-between items-start mb-6 lg:mb-0 lg:mt-8 w-full animate-project-description px-1 md:px-2" key={selectedProject}>
          <div 
        ...
        {/* 
            Image Container
        */}
        <div className="flex-1 relative w-full h-full min-h-[350px] md:min-h-[500px] overflow-hidden lg:mt-8">
