...
/**
 * Git skill icon component.
 * Displays the Git logo and wordmark.
 */
export const GitSkillIcon: React.FC<IconProps> = ({ className }) => {
  return (
    <div className={`${className} flex items-center justify-center`}>
      ...
      >
        <defs>
          <clipPath id="git-clip-a">
            <path d="M159 .79h25V69h-25Zm0 0" />
          </clipPath>
          <clipPath id="git-clip-b">
            <path d="M183 9h35.371v60H183Zm0 0" />
          </clipPath>
          <clipPath id="git-clip-c">
